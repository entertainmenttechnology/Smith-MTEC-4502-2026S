...
1. **Create a personal folder** named after you (e.g., `firstname-lastname/` or your GitHub username)
2. **Use this folder as your workspace** for all MTEC 4502 assignments, reflections, and portfolio work
...
└── firstname-lastname/
    ├── assignments/
    │   ├── 01-career-strategy/
    │   ├── 02-career-visualization/
    │   ├── 03-portfolio-platforms/
    │   ├── 04-ai-portfolio/
    │   └── 05-resume-cover-letter/
    ├── reflections/
    ├── research-notes/
