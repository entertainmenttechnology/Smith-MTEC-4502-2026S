...
## [SUBMIT SCAFFOLDED ESSAY PART 1](https://brightspace.cuny.edu/d2l/le/content/950238/viewContent/34397524/View?ou=950238)

This link takes you to the Brightspace site where you can submit part 1 of the assignment.
...
This article is from Dell (it is always critical to identify your source, as this helps determine in which direction the article may be biased) and discusses how technology is going to change employment and careers. It is critical to be able to evaluate how your career may change in the future based on changes to industry, society etc. We of course can not "see" the future, but we can make predictions based on trends, past cyclical phenomena, etc.
...
This site lists a variety of different job boards, mailing lists, organizations and other entities that hire. You will want to deep dive into this: explore the different boards, identify which seem most relevant to your interests.
