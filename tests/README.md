...
Tests that `assignments/01c MTEC 4502 Assignment week 3  - Integrating Visualization.md` contains a level-one heading as required by WCAG 2.1 (page-has-heading-one rule).
