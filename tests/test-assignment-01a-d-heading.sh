#!/bin/bash
# Specific test for assignments/01a-d Scaffolded Assignment_ Reflective and analytical essay.md accessibility
# Ensures the file has a level-one heading as required by WCAG 2.1

set -e

FILE="assignments/01a-d Scaffolded Assignment_ Reflective and analytical essay.md"
