#!/bin/bash
# Specific test for assignments/11_Session Resume Development Assignment.md accessibility
# Ensures the file has a level-one heading as required by WCAG 2.1
# This helps prevent color contrast issues caused by improper heading structure
