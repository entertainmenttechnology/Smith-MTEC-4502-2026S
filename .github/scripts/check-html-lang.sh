...
# This helps prevent accessibility issues where HTML pages lack language identification
# (html-has-lang axe rule, WCAG 2.1 Success Criterion 3.1.1 - Language of Page)
#
